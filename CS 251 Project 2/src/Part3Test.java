...
public class Part3Test {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        for (int j = 0; j < gen.nextInt(10) + 10; j++) {
            ...
            // checkPriorityQueue
            System.out.println("!!!!!!!!!!!!!!!!!!!!!!!");
            for (int Q = 0; Q < cq.getOrderList().length; Q++)
            {
                if (cq.getOrderList()[Q] != null)
                {
                    System.out.println(cq.getOrderList()[Q]);
                }
            }
            if (!checkPriorityQueue(cq, 0)) {
                CustomerOrder[] temp = cq.getOrderList();
                System.out.println("INCORECT PRIORITY QUEUE REMOVE");
                score = 0.0;
            }
        }
        if (pass) {
        ...
        // checkPriorityQueue
        if (!checkPriorityQueue(cq, 0)) {
            System.out.println("INCORECT PRIORITY QUEUE REMOVE 2");
            score = 0.0;
        }
        ...
        if (!checkPriorityQueue(cq, 0)) {
            System.out.println("INCORECT PRIORITY QUEUE UPDATE");
            score = 0.0;
        }
        ...
        if (!checkPriorityQueue(cq, 0)) {
            System.out.println("INCORECT PRIORITY QUEUE UPDATE 2");
            score = 0.0;
        }
        ...
        while (!list.isEmpty()) {
            ...
            System.out.println("EXPECTED: " + pExp);
            CustomerOrder pAct = cq.getMax();
            System.out.println("ACTUAL: " + pAct);
            if (pExp != pAct) {
